...
insert  into `complaint`(`complaint_id`,`user_id`,`complaint`,`complaint_date`,`reply`,`replydate`) values (1,1,'duplicate',NULL,'bvvh',20230126);
...
insert  into `login`(`loginid`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'m','m','manufacture'),(3,'ssreeharikv@gmail.com','admin13','manufacture'),(4,'ssreeharikv@gmail.com','admin13','manufacture'),(5,'stb@gmail.com','admin14','manufacture'),(6,'hr@gmail.com','admin15','manufacture');
...
insert  into `user`(`user_id`,`name`,`email`,`phone_no`) values (1,'hh','h@gmail.com',9876);
